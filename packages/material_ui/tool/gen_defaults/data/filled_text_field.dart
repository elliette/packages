...
class TokenFilledTextField {
  ...
  static const ShapeStruct containerShape = ShapeStruct(family: 'SHAPE_FAMILY_ROUNDED_CORNERS', topLeft: 4.00, topRight: 4.00, bottomLeft: 0.00, bottomRight: 0.00);
  ...
  static const TypescaleStruct inputTextType = TypescaleStruct(fontFamily: 'Roboto', fontSize: 16.00, fontWeight: 400, lineHeight: 24.00, letterSpacing: 0.50);
  /// md.comp.filled-text-field.label-text.type
  static const TypescaleStruct labelTextType = TypescaleStruct(fontFamily: 'Roboto', fontSize: 16.00, fontWeight: 400, lineHeight: 24.00, letterSpacing: 0.50);
  ...
  static const TypescaleStruct supportingTextType = TypescaleStruct(fontFamily: 'Roboto', fontSize: 12.00, fontWeight: 400, lineHeight: 16.00, letterSpacing: 0.40);

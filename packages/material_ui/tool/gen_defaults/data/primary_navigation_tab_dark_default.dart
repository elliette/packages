...
class TokenPrimaryNavigationTabDarkDefault {
  ...
  static const String activeFocusStateLayerColor = '0xFFD0BCFF';

  /// md.comp.primary-navigation-tab.active.hover.state-layer.color
  static const String activeHoverStateLayerColor = '0xFFD0BCFF';

  /// md.comp.primary-navigation-tab.active-indicator.color
  static const String activeIndicatorColor = '0xFFD0BCFF';

  /// md.comp.primary-navigation-tab.active.pressed.state-layer.color
  static const String activePressedStateLayerColor = '0xFFD0BCFF';

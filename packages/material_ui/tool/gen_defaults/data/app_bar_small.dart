...
class TokenAppBarSmall {
  ...
  static const TypescaleStruct searchLabelTextFont = Typescale.bodyLarge;

  /// md.comp.app-bar.small.subtitle.font
  static const TypescaleStruct subtitleFont = Typescale.bodyLarge;

  /// md.comp.app-bar.small.title.font
  static const TypescaleStruct titleFont = Typescale.bodyLarge;
}

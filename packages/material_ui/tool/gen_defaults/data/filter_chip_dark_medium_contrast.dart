...
class TokenFilterChipDarkMediumContrast {
  ...
  static const String elevatedDisabledContainerColor = '0xFFFFFFFF';

  /// md.comp.filter-chip.elevated.selected.container.color
  static const String elevatedSelectedContainerColor = '0xFF958DA5';
  ...
  static const String flatDisabledSelectedContainerColor = '0xFFFFFFFF';

  /// md.comp.filter-chip.flat.disabled.unselected.outline.color
  static const String flatDisabledUnselectedOutlineColor = '0xFFFFFFFF';

  /// md.comp.filter-chip.flat.selected.container.color
  static const String flatSelectedContainerColor = '0xFF958DA5';

  /// md.comp.filter-chip.flat.unselected.focus.outline.color
  static const String flatUnselectedFocusOutlineColor = '0xFFE7E0EC';

  /// md.comp.filter-chip.flat.unselected.outline.color
  static const String flatUnselectedOutlineColor = '0xFF938F99';
  ...
  static const String selectedDraggedLabelTextColor = '0xFF000000';

  /// md.comp.filter-chip.selected.dragged.state-layer.color
  static const String selectedDraggedStateLayerColor = '0xFF000000';

  /// md.comp.filter-chip.selected.focus.label-text.color
  static const String selectedFocusLabelTextColor = '0xFF000000';

  /// md.comp.filter-chip.selected.focus.state-layer.color
  static const String selectedFocusStateLayerColor = '0xFF000000';

  /// md.comp.filter-chip.selected.hover.label-text.color
  static const String selectedHoverLabelTextColor = '0xFF000000';

  /// md.comp.filter-chip.selected.hover.state-layer.color
  static const String selectedHoverStateLayerColor = '0xFF000000';
  ...
  static const String selectedPressedStateLayerColor = '0xFFE7E0EC';

  /// md.comp.filter-chip.unselected.dragged.label-text.color
  static const String unselectedDraggedLabelTextColor = '0xFFE7E0EC';

  /// md.comp.filter-chip.unselected.dragged.state-layer.color
  static const String unselectedDraggedStateLayerColor = '0xFFE7E0EC';

  /// md.comp.filter-chip.unselected.focus.label-text.color
  static const String unselectedFocusLabelTextColor = '0xFFE7E0EC';

  /// md.comp.filter-chip.unselected.focus.state-layer.color
  static const String unselectedFocusStateLayerColor = '0xFFE7E0EC';

  /// md.comp.filter-chip.unselected.hover.label-text.color
  static const String unselectedHoverLabelTextColor = '0xFFE7E0EC';

  /// md.comp.filter-chip.unselected.hover.state-layer.color
  static const String unselectedHoverStateLayerColor = '0xFFE7E0EC';
  ...
  static const String withLeadingIconDisabledLeadingIconColor = '0xFFFFFFFF';
  ...
  static const String withLeadingIconSelectedLeadingIconColor = '0xFF000000';
  ...
  static const String withLeadingIconUnselectedLeadingIconColor = '0xFFEADDFF';
  ...
  static const String withTrailingIconDisabledTrailingIconColor = '0xFFFFFFFF';
  ...
  static const String withTrailingIconSelectedTrailingIconColor = '0xFF000000';

...
class TokenButtonOutlinedLightMediumContrast {
  ...
  static const String disabledOutlineColor = '0xFF79747E';

  /// md.comp.button.outlined.focused.icon.color
  static const String focusedIconColor = '0xFF322F37';

  /// md.comp.button.outlined.focused.label-text.color
  static const String focusedLabelTextColor = '0xFF322F37';

  /// md.comp.button.outlined.focused.outline.color
  static const String focusedOutlineColor = '0xFF79747E';

  /// md.comp.button.outlined.focused.state-layer.color
  static const String focusedStateLayerColor = '0xFF322F37';

  /// md.comp.button.outlined.hovered.icon.color
  static const String hoveredIconColor = '0xFF322F37';

  /// md.comp.button.outlined.hovered.label-text.color
  static const String hoveredLabelTextColor = '0xFF322F37';

  /// md.comp.button.outlined.hovered.outline.color
  static const String hoveredOutlineColor = '0xFF79747E';

  /// md.comp.button.outlined.hovered.state-layer.color
  static const String hoveredStateLayerColor = '0xFF322F37';

  /// md.comp.button.outlined.icon.color
  static const String iconColor = '0xFF322F37';
  ...
  static const String pressedIconColor = '0xFF322F37';

  /// md.comp.button.outlined.pressed.label-text.color
  static const String pressedLabelTextColor = '0xFF322F37';

  /// md.comp.button.outlined.pressed.outline.color
  static const String pressedOutlineColor = '0xFF79747E';

  /// md.comp.button.outlined.pressed.state-layer.color
  static const String pressedStateLayerColor = '0xFF322F37';
  ...
  static const String unselectedDisabledOutlineColor = '0xFF79747E';

  /// md.comp.button.outlined.unselected.focused.icon.color
  static const String unselectedFocusedIconColor = '0xFF322F37';

  /// md.comp.button.outlined.unselected.focused.label-text.color
  static const String unselectedFocusedLabelTextColor = '0xFF322F37';

  /// md.comp.button.outlined.unselected.focused.outline.color
  static const String unselectedFocusedOutlineColor = '0xFF79747E';

  /// md.comp.button.outlined.unselected.focused.state-layer.color
  static const String unselectedFocusedStateLayerColor = '0xFF322F37';

  /// md.comp.button.outlined.unselected.hovered.icon.color
  static const String unselectedHoveredIconColor = '0xFF322F37';

  /// md.comp.button.outlined.unselected.hovered.label-text.color
  static const String unselectedHoveredLabelTextColor = '0xFF322F37';

  /// md.comp.button.outlined.unselected.hovered.outline.color
  static const String unselectedHoveredOutlineColor = '0xFF79747E';

  /// md.comp.button.outlined.unselected.hovered.state-layer.color
  static const String unselectedHoveredStateLayerColor = '0xFF322F37';

  /// md.comp.button.outlined.unselected.icon.color
  static const String unselectedIconColor = '0xFF322F37';
  ...
  static const String unselectedPressedIconColor = '0xFF322F37';
  ...
  static const String unselectedPressedOutlineColor = '0xFF79747E';

  /// md.comp.button.outlined.unselected.pressed.state-layer.color
  static const String unselectedPressedStateLayerColor = '0xFF322F37';
}

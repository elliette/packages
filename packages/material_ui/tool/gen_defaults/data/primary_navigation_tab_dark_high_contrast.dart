...
class TokenPrimaryNavigationTabDarkHighContrast {
  ...
  static const String activeFocusStateLayerColor = '0xFFF6EDFF';

  /// md.comp.primary-navigation-tab.active.hover.state-layer.color
  static const String activeHoverStateLayerColor = '0xFFF6EDFF';

  /// md.comp.primary-navigation-tab.active-indicator.color
  static const String activeIndicatorColor = '0xFFF6EDFF';

  /// md.comp.primary-navigation-tab.active.pressed.state-layer.color
  static const String activePressedStateLayerColor = '0xFFF6EDFF';

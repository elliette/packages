...
class TokenDatePickerDockedDarkDefault {
  ...
  static const String dateSelectedContainerColor = '0xFFD0BCFF';

  /// md.comp.date-picker.docked.date.selected.focus.state-layer.color
  static const String dateSelectedFocusStateLayerColor = '0xFF381E72';

  /// md.comp.date-picker.docked.date.selected.hover.state-layer.color
  static const String dateSelectedHoverStateLayerColor = '0xFF381E72';

  /// md.comp.date-picker.docked.date.selected.label-text.color
  static const String dateSelectedLabelTextColor = '0xFF381E72';

  /// md.comp.date-picker.docked.date.selected.pressed.state-layer.color
  static const String dateSelectedPressedStateLayerColor = '0xFF381E72';

  /// md.comp.date-picker.docked.date.today.container.outline.color
  static const String dateTodayContainerOutlineColor = '0xFFD0BCFF';

  /// md.comp.date-picker.docked.date.today.focus.state-layer.color
  static const String dateTodayFocusStateLayerColor = '0xFFD0BCFF';

  /// md.comp.date-picker.docked.date.today.hover.state-layer.color
  static const String dateTodayHoverStateLayerColor = '0xFFD0BCFF';

  /// md.comp.date-picker.docked.date.today.label-text.color
  static const String dateTodayLabelTextColor = '0xFFD0BCFF';

  /// md.comp.date-picker.docked.date.today.pressed.state-layer.color
  static const String dateTodayPressedStateLayerColor = '0xFFD0BCFF';

  /// md.comp.date-picker.docked.date.unselected.focus.state-layer.color
  static const String dateUnselectedFocusStateLayerColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.date.unselected.hover.state-layer.color
  static const String dateUnselectedHoverStateLayerColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.date.unselected.label-text.color
  static const String dateUnselectedLabelTextColor = '0xFFE6E0E9';

  /// md.comp.date-picker.docked.date.unselected.outside-month.label-text.color
  static const String dateUnselectedOutsideMonthLabelTextColor = '0xFFE6E0E9';

  /// md.comp.date-picker.docked.date.unselected.pressed.state-layer.color
  static const String dateUnselectedPressedStateLayerColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu-button.disabled.icon.color
  static const String menuButtonDisabledIconColor = '0xFFE6E0E9';

  /// md.comp.date-picker.docked.menu-button.disabled.label-text.color
  static const String menuButtonDisabledLabelTextColor = '0xFFE6E0E9';

  /// md.comp.date-picker.docked.menu-button.focus.icon.color
  static const String menuButtonFocusIconColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu-button.focus.label-text.color
  static const String menuButtonFocusLabelTextColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu-button.focus.state-layer.color
  static const String menuButtonFocusStateLayerColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu-button.hover.icon.color
  static const String menuButtonHoverIconColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu-button.hover.label-text.color
  static const String menuButtonHoverLabelTextColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu-button.hover.state-layer.color
  static const String menuButtonHoverStateLayerColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu-button.icon.color
  static const String menuButtonIconColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu-button.label-text.color
  static const String menuButtonLabelTextColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu-button.pressed.icon.color
  static const String menuButtonPressedIconColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu-button.pressed.label-text.color
  static const String menuButtonPressedLabelTextColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu-button.pressed.state-layer.color
  static const String menuButtonPressedStateLayerColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu.list-item.focus.label-text.color
  static const String menuListItemFocusLabelTextColor = '0xFFE6E0E9';

  /// md.comp.date-picker.docked.menu.list-item.focus.state-layer.color
  static const String menuListItemFocusStateLayerColor = '0xFFE6E0E9';

  /// md.comp.date-picker.docked.menu.list-item.hover.label-text.color
  static const String menuListItemHoverLabelTextColor = '0xFFE6E0E9';

  /// md.comp.date-picker.docked.menu.list-item.hover.state-layer.color
  static const String menuListItemHoverStateLayerColor = '0xFFE6E0E9';
  ...
  static const String menuListItemPressedLabelTextColor = '0xFFE6E0E9';

  /// md.comp.date-picker.docked.menu.list-item.pressed.state-layer.color
  static const String menuListItemPressedStateLayerColor = '0xFFE6E0E9';

  /// md.comp.date-picker.docked.menu.list-item.selected.focus.leading-icon.color
  static const String menuListItemSelectedFocusLeadingIconColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu.list-item.selected.hover.leading-icon.color
  static const String menuListItemSelectedHoverLeadingIconColor = '0xFFCAC4D0';

  /// md.comp.date-picker.docked.menu.list-item.selected.leading-icon.color
  static const String menuListItemSelectedLeadingIconColor = '0xFFE6E0E9';
  ...
  static const String weekdaysLabelTextColor = '0xFFE6E0E9';
}

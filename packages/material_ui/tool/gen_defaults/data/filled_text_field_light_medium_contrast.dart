...
class TokenFilledTextFieldLightMediumContrast {
  ...
  static const String activeIndicatorColor = '0xFF322F37';

  /// md.comp.filled-text-field.caret.color
  static const String caretColor = '0xFF4F378B';
  ...
  static const String errorActiveIndicatorColor = '0xFF8C1D18';

  /// md.comp.filled-text-field.error.focus.active-indicator.color
  static const String errorFocusActiveIndicatorColor = '0xFF8C1D18';

  /// md.comp.filled-text-field.error.focus.caret.color
  static const String errorFocusCaretColor = '0xFF8C1D18';
  ...
  static const String errorFocusLabelTextColor = '0xFF8C1D18';

  /// md.comp.filled-text-field.error.focus.leading-icon.color
  static const String errorFocusLeadingIconColor = '0xFF322F37';

  /// md.comp.filled-text-field.error.focus.supporting-text.color
  static const String errorFocusSupportingTextColor = '0xFF8C1D18';

  /// md.comp.filled-text-field.error.focus.trailing-icon.color
  static const String errorFocusTrailingIconColor = '0xFF8C1D18';
  ...
  static const String errorHoverLeadingIconColor = '0xFF322F37';
  ...
  static const String errorHoverSupportingTextColor = '0xFF8C1D18';
  ...
  static const String errorLabelTextColor = '0xFF8C1D18';

  /// md.comp.filled-text-field.error.leading-icon.color
  static const String errorLeadingIconColor = '0xFF322F37';

  /// md.comp.filled-text-field.error.supporting-text.color
  static const String errorSupportingTextColor = '0xFF8C1D18';

  /// md.comp.filled-text-field.error.trailing-icon.color
  static const String errorTrailingIconColor = '0xFF8C1D18';

  /// md.comp.filled-text-field.focus.active-indicator.color
  static const String focusActiveIndicatorColor = '0xFF4F378B';
  ...
  static const String focusLabelTextColor = '0xFF4F378B';

  /// md.comp.filled-text-field.focus.leading-icon.color
  static const String focusLeadingIconColor = '0xFF322F37';

  /// md.comp.filled-text-field.focus.supporting-text.color
  static const String focusSupportingTextColor = '0xFF322F37';

  /// md.comp.filled-text-field.focus.trailing-icon.color
  static const String focusTrailingIconColor = '0xFF322F37';
  ...
  static const String hoverLabelTextColor = '0xFF322F37';

  /// md.comp.filled-text-field.hover.leading-icon.color
  static const String hoverLeadingIconColor = '0xFF322F37';
  ...
  static const String hoverSupportingTextColor = '0xFF322F37';

  /// md.comp.filled-text-field.hover.trailing-icon.color
  static const String hoverTrailingIconColor = '0xFF322F37';
  ...
  static const String inputTextPlaceholderColor = '0xFF322F37';

  /// md.comp.filled-text-field.input-text.prefix.color
  static const String inputTextPrefixColor = '0xFF322F37';

  /// md.comp.filled-text-field.input-text.suffix.color
  static const String inputTextSuffixColor = '0xFF322F37';

  /// md.comp.filled-text-field.label-text.color
  static const String labelTextColor = '0xFF322F37';

  /// md.comp.filled-text-field.leading-icon.color
  static const String leadingIconColor = '0xFF322F37';

  /// md.comp.filled-text-field.supporting-text.color
  static const String supportingTextColor = '0xFF322F37';

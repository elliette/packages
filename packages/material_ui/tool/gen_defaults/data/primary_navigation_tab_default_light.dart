...
class TokenPrimaryNavigationTabDefault_light {
  /// md.comp.primary-navigation-tab.active.focus.state-layer.color
  static const String activeFocusStateLayerColor = '0xFF6750A4';

  /// md.comp.primary-navigation-tab.active.hover.state-layer.color
  static const String activeHoverStateLayerColor = '0xFF6750A4';

  /// md.comp.primary-navigation-tab.active-indicator.color
  static const String activeIndicatorColor = '0xFF6750A4';

  /// md.comp.primary-navigation-tab.active.pressed.state-layer.color
  static const String activePressedStateLayerColor = '0xFF6750A4';

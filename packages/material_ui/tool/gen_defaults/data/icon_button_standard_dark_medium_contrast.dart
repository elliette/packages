...
class TokenIconButtonStandardDarkMediumContrast {
  ...
  static const String selectedFocusedIconColor = '0xFFEADDFF';

  /// md.comp.icon-button.standard.selected.focused.state-layer.color
  static const String selectedFocusedStateLayerColor = '0xFFEADDFF';

  /// md.comp.icon-button.standard.selected.hovered.icon.color
  static const String selectedHoveredIconColor = '0xFFEADDFF';

  /// md.comp.icon-button.standard.selected.hovered.state-layer.color
  static const String selectedHoveredStateLayerColor = '0xFFEADDFF';

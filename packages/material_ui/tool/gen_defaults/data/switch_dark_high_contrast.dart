...
class TokenSwitchDarkHighContrast {
  ...
  static const String selectedFocusHandleColor = '0xFFD0BCFF';

  /// md.comp.switch.selected.focus.icon.color
  static const String selectedFocusIconColor = '0xFFF6EDFF';
  ...
  static const String selectedFocusTrackColor = '0xFFF6EDFF';

  /// md.comp.switch.selected.handle.color
  static const String selectedHandleColor = '0xFF000000';

  /// md.comp.switch.selected.hover.handle.color
  static const String selectedHoverHandleColor = '0xFFD0BCFF';

  /// md.comp.switch.selected.hover.icon.color
  static const String selectedHoverIconColor = '0xFFF6EDFF';
  ...
  static const String selectedHoverTrackColor = '0xFFF6EDFF';

  /// md.comp.switch.selected.icon.color
  static const String selectedIconColor = '0xFFF6EDFF';

  /// md.comp.switch.selected.pressed.handle.color
  static const String selectedPressedHandleColor = '0xFFD0BCFF';

  /// md.comp.switch.selected.pressed.icon.color
  static const String selectedPressedIconColor = '0xFFF6EDFF';

  /// md.comp.switch.selected.pressed.state-layer.color
  static const String selectedPressedStateLayerColor = '0xFFF6EDFF';

  /// md.comp.switch.selected.pressed.track.color
  static const String selectedPressedTrackColor = '0xFFF6EDFF';

  /// md.comp.switch.selected.track.color
  static const String selectedTrackColor = '0xFFF6EDFF';

  /// md.comp.switch.unselected.focus.handle.color
  static const String unselectedFocusHandleColor = '0xFFFFFFFF';
  ...
  static const String unselectedFocusTrackOutlineColor = '0xFFF5EEFA';

  /// md.comp.switch.unselected.handle.color
  static const String unselectedHandleColor = '0xFFF5EEFA';

  /// md.comp.switch.unselected.hover.handle.color
  static const String unselectedHoverHandleColor = '0xFFFFFFFF';
  ...
  static const String unselectedHoverTrackOutlineColor = '0xFFF5EEFA';
  ...
  static const String unselectedPressedHandleColor = '0xFFFFFFFF';
  ...
  static const String unselectedPressedTrackOutlineColor = '0xFFF5EEFA';
  ...
  static const String unselectedTrackOutlineColor = '0xFFF5EEFA';
}

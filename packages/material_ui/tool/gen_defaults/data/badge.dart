...
class TokenBadgeDarkHighContrast {
  /// md.comp.badge.color
  static const TokenColorRole color = TokenColorRole.error;
...
class TokenBadgeDarkMediumContrast {
  /// md.comp.badge.color
  static const TokenColorRole color = TokenColorRole.error;
...
class TokenBadgeLightHighContrast {
  /// md.comp.badge.color
  static const TokenColorRole color = TokenColorRole.error;
...
class TokenBadgeLightMediumContrast {
  /// md.comp.badge.color
  static const TokenColorRole color = TokenColorRole.error;

...
class TokenFilterChipDefault_light {
  ...
  static const String elevatedDisabledContainerColor = '0xFF1D1B20';

  /// md.comp.filter-chip.elevated.selected.container.color
  static const String elevatedSelectedContainerColor = '0xFFE8DEF8';

  /// md.comp.filter-chip.flat.disabled.selected.container.color
  static const String flatDisabledSelectedContainerColor = '0xFF1D1B20';

  /// md.comp.filter-chip.flat.disabled.unselected.outline.color
  static const String flatDisabledUnselectedOutlineColor = '0xFF1D1B20';

  /// md.comp.filter-chip.flat.selected.container.color
  static const String flatSelectedContainerColor = '0xFFE8DEF8';

  /// md.comp.filter-chip.flat.unselected.focus.outline.color
  static const String flatUnselectedFocusOutlineColor = '0xFF49454F';

  /// md.comp.filter-chip.flat.unselected.outline.color
  static const String flatUnselectedOutlineColor = '0xFFCAC4D0';
  ...
  static const String selectedDraggedLabelTextColor = '0xFF4A4458';

  /// md.comp.filter-chip.selected.dragged.state-layer.color
  static const String selectedDraggedStateLayerColor = '0xFF4A4458';

  /// md.comp.filter-chip.selected.focus.label-text.color
  static const String selectedFocusLabelTextColor = '0xFF4A4458';

  /// md.comp.filter-chip.selected.focus.state-layer.color
  static const String selectedFocusStateLayerColor = '0xFF4A4458';

  /// md.comp.filter-chip.selected.hover.label-text.color
  static const String selectedHoverLabelTextColor = '0xFF4A4458';

  /// md.comp.filter-chip.selected.hover.state-layer.color
  static const String selectedHoverStateLayerColor = '0xFF4A4458';

  /// md.comp.filter-chip.selected.label-text.color
  static const String selectedLabelTextColor = '0xFF4A4458';

  /// md.comp.filter-chip.selected.pressed.label-text.color
  static const String selectedPressedLabelTextColor = '0xFF4A4458';

  /// md.comp.filter-chip.selected.pressed.state-layer.color
  static const String selectedPressedStateLayerColor = '0xFF49454F';

  /// md.comp.filter-chip.unselected.dragged.label-text.color
  static const String unselectedDraggedLabelTextColor = '0xFF49454F';

  /// md.comp.filter-chip.unselected.dragged.state-layer.color
  static const String unselectedDraggedStateLayerColor = '0xFF49454F';

  /// md.comp.filter-chip.unselected.focus.label-text.color
  static const String unselectedFocusLabelTextColor = '0xFF49454F';

  /// md.comp.filter-chip.unselected.focus.state-layer.color
  static const String unselectedFocusStateLayerColor = '0xFF49454F';

  /// md.comp.filter-chip.unselected.hover.label-text.color
  static const String unselectedHoverLabelTextColor = '0xFF49454F';

  /// md.comp.filter-chip.unselected.hover.state-layer.color
  static const String unselectedHoverStateLayerColor = '0xFF49454F';
  ...
  static const String withLeadingIconDisabledLeadingIconColor = '0xFF1D1B20';
  ...
  static const String withLeadingIconSelectedLeadingIconColor = '0xFF4A4458';
  ...
  static const String withLeadingIconUnselectedLeadingIconColor = '0xFF6750A4';
  ...
  static const String withTrailingIconDisabledTrailingIconColor = '0xFF1D1B20';
  ...
  static const String withTrailingIconSelectedTrailingIconColor = '0xFF4A4458';

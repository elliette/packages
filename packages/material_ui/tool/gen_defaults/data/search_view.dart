...
class TokenSearchView {
  ...
  static const ShapeStruct containedDockedBarShape = ShapeStruct(family: 'SHAPE_FAMILY_CIRCULAR', topLeft: 0.00, topRight: 0.00, bottomLeft: 0.00, bottomRight: 0.00);
  /// md.comp.search-view.contained.docked.results.shape
  static const ShapeStruct containedDockedResultsShape = ShapeStruct(family: 'SHAPE_FAMILY_ROUNDED_CORNERS', topLeft: 12.00, topRight: 12.00, bottomLeft: 12.00, bottomRight: 12.00);
  ...
  static const ShapeStruct dockedContainerShape = ShapeStruct(family: 'SHAPE_FAMILY_ROUNDED_CORNERS', topLeft: 28.00, topRight: 28.00, bottomLeft: 28.00, bottomRight: 28.00);
  ...
  static const ShapeStruct fullScreenContainerShape = ShapeStruct(family: 'SHAPE_FAMILY_ROUNDED_CORNERS', topLeft: 0.00, topRight: 0.00, bottomLeft: 0.00, bottomRight: 0.00);
  ...
  static const TypescaleStruct headerInputTextType = TypescaleStruct(fontFamily: 'Roboto', fontSize: 16.00, fontWeight: 400, lineHeight: 24.00, letterSpacing: 0.50);
  /// md.comp.search-view.header.supporting-text.type
  static const TypescaleStruct headerSupportingTextType = TypescaleStruct(fontFamily: 'Roboto', fontSize: 16.00, fontWeight: 400, lineHeight: 24.00, letterSpacing: 0.50);

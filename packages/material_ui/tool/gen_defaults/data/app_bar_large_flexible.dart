...
class TokenAppBarLargeFlexible {
  ...
  static const TypescaleStruct subtitleFont = TypescaleStruct(fontFamily: 'Roboto', fontSize: 16.00, fontWeight: 500, lineHeight: 24.00, letterSpacing: 0.15);
  /// md.comp.app-bar.large-flexible.title.font
  static const TypescaleStruct titleFont = TypescaleStruct(fontFamily: 'Roboto', fontSize: 36.00, fontWeight: 400, lineHeight: 44.00, letterSpacing: 0.00);

...
class TokenTimeInput {
  ...
  static const ShapeStruct timeInputFieldContainerShape = ShapeStruct(family: 'SHAPE_FAMILY_ROUNDED_CORNERS', topLeft: 8.00, topRight: 8.00, bottomLeft: 8.00, bottomRight: 8.00);
  ...
  static const TypescaleStruct timeInputFieldLabelTextType = TypescaleStruct(fontFamily: 'Roboto', fontSize: 45.00, fontWeight: 400, lineHeight: 52.00, letterSpacing: 0.00);
  /// md.comp.time-input.time-input-field.separator.type
  static const TypescaleStruct timeInputFieldSeparatorType = TypescaleStruct(fontFamily: 'Roboto', fontSize: 57.00, fontWeight: 400, lineHeight: 64.00, letterSpacing: -0.25);
  /// md.comp.time-input.time-input-field.supporting-text.type
  static const TypescaleStruct timeInputFieldSupportingTextType = TypescaleStruct(fontFamily: 'Roboto', fontSize: 12.00, fontWeight: 400, lineHeight: 16.00, letterSpacing: 0.40);
}

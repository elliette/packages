...
class TokenPrimaryNavigationTabDarkMediumContrast {
  ...
  static const String activeFocusStateLayerColor = '0xFFEADDFF';

  /// md.comp.primary-navigation-tab.active.hover.state-layer.color
  static const String activeHoverStateLayerColor = '0xFFEADDFF';

  /// md.comp.primary-navigation-tab.active-indicator.color
  static const String activeIndicatorColor = '0xFFEADDFF';

  /// md.comp.primary-navigation-tab.active.pressed.state-layer.color
  static const String activePressedStateLayerColor = '0xFFEADDFF';
  ...
  static const String inactivePressedStateLayerColor = '0xFFEADDFF';

  /// md.comp.primary-navigation-tab.with-icon.active.focus.icon.color
  static const String withIconActiveFocusIconColor = '0xFFEADDFF';

  /// md.comp.primary-navigation-tab.with-icon.active.hover.icon.color
  static const String withIconActiveHoverIconColor = '0xFFEADDFF';

  /// md.comp.primary-navigation-tab.with-icon.active.icon.color
  static const String withIconActiveIconColor = '0xFFEADDFF';

  /// md.comp.primary-navigation-tab.with-icon.active.pressed.icon.color
  static const String withIconActivePressedIconColor = '0xFFEADDFF';
  ...
  static const String withIconInactiveIconColor = '0xFFE7E0EC';
  ...
  static const String withLabelTextActiveFocusLabelTextColor = '0xFFEADDFF';

  /// md.comp.primary-navigation-tab.with-label-text.active.hover.label-text.color
  static const String withLabelTextActiveHoverLabelTextColor = '0xFFEADDFF';

  /// md.comp.primary-navigation-tab.with-label-text.active.label-text.color
  static const String withLabelTextActiveLabelTextColor = '0xFFEADDFF';

  /// md.comp.primary-navigation-tab.with-label-text.active.pressed.label-text.color
  static const String withLabelTextActivePressedLabelTextColor = '0xFFEADDFF';
  ...
  static const String withLabelTextInactiveLabelTextColor = '0xFFE7E0EC';

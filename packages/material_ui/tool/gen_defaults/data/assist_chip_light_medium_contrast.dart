...
class TokenAssistChipLightMediumContrast {
  ...
  static const String withIconDraggedIconColor = '0xFF4F378B';

  /// md.comp.assist-chip.with-icon.focus.icon.color
  static const String withIconFocusIconColor = '0xFF4F378B';

  /// md.comp.assist-chip.with-icon.hover.icon.color
  static const String withIconHoverIconColor = '0xFF4F378B';

  /// md.comp.assist-chip.with-icon.icon.color
  static const String withIconIconColor = '0xFF4F378B';

  /// md.comp.assist-chip.with-icon.pressed.icon.color
  static const String withIconPressedIconColor = '0xFF4F378B';
}

...
class TokenTimeInputDarkHighContrast {
  ...
  static const String timeInputFieldFocusContainerColor = '0xFFD0BCFF';

  /// md.comp.time-input.time-input-field.focus.label-text.color
  static const String timeInputFieldFocusLabelTextColor = '0xFF000000';

  /// md.comp.time-input.time-input-field.focus.outline.color
  static const String timeInputFieldFocusOutlineColor = '0xFFF6EDFF';

  /// md.comp.time-input.time-input-field.hover.label-text.color
  static const String timeInputFieldHoverLabelTextColor = '0xFFFFFFFF';

  /// md.comp.time-input.time-input-field.hover.state-layer.color
  static const String timeInputFieldHoverStateLayerColor = '0xFFFFFFFF';

  /// md.comp.time-input.time-input-field.label-text.color
  static const String timeInputFieldLabelTextColor = '0xFFFFFFFF';

  /// md.comp.time-input.time-input-field.separator.color
  static const String timeInputFieldSeparatorColor = '0xFFFFFFFF';

  /// md.comp.time-input.time-input-field.supporting-text.color
  static const String timeInputFieldSupportingTextColor = '0xFFFFFFFF';
}

...
class TokenFilterChipDark {
  ...
  static const String elevatedContainerShadowColor = '0xFF000000';

  /// md.comp.filter-chip.elevated.disabled.container.color
  static const String elevatedDisabledContainerColor = '0xFFE6E0E9';

  /// md.comp.filter-chip.elevated.selected.container.color
  static const String elevatedSelectedContainerColor = '0xFF4A4458';

  /// md.comp.filter-chip.elevated.unselected.container.color
  static const String elevatedUnselectedContainerColor = '0xFF1D1B20';

  /// md.comp.filter-chip.flat.disabled.selected.container.color
  static const String flatDisabledSelectedContainerColor = '0xFFE6E0E9';

  /// md.comp.filter-chip.flat.disabled.unselected.outline.color
  static const String flatDisabledUnselectedOutlineColor = '0xFFE6E0E9';

  /// md.comp.filter-chip.flat.selected.container.color
  static const String flatSelectedContainerColor = '0xFF4A4458';

  /// md.comp.filter-chip.flat.unselected.focus.outline.color
  static const String flatUnselectedFocusOutlineColor = '0xFFCAC4D0';

  /// md.comp.filter-chip.flat.unselected.outline.color
  static const String flatUnselectedOutlineColor = '0xFF49454F';
  ...
  static const String selectedDraggedLabelTextColor = '0xFFE8DEF8';

  /// md.comp.filter-chip.selected.dragged.state-layer.color
  static const String selectedDraggedStateLayerColor = '0xFFE8DEF8';

  /// md.comp.filter-chip.selected.focus.label-text.color
  static const String selectedFocusLabelTextColor = '0xFFE8DEF8';

  /// md.comp.filter-chip.selected.focus.state-layer.color
  static const String selectedFocusStateLayerColor = '0xFFE8DEF8';

  /// md.comp.filter-chip.selected.hover.label-text.color
  static const String selectedHoverLabelTextColor = '0xFFE8DEF8';

  /// md.comp.filter-chip.selected.hover.state-layer.color
  static const String selectedHoverStateLayerColor = '0xFFE8DEF8';

  /// md.comp.filter-chip.selected.label-text.color
  static const String selectedLabelTextColor = '0xFFE8DEF8';

  /// md.comp.filter-chip.selected.pressed.label-text.color
  static const String selectedPressedLabelTextColor = '0xFFE8DEF8';

  /// md.comp.filter-chip.selected.pressed.state-layer.color
  static const String selectedPressedStateLayerColor = '0xFFCAC4D0';

  /// md.comp.filter-chip.unselected.dragged.label-text.color
  static const String unselectedDraggedLabelTextColor = '0xFFCAC4D0';

  /// md.comp.filter-chip.unselected.dragged.state-layer.color
  static const String unselectedDraggedStateLayerColor = '0xFFCAC4D0';

  /// md.comp.filter-chip.unselected.focus.label-text.color
  static const String unselectedFocusLabelTextColor = '0xFFCAC4D0';

  /// md.comp.filter-chip.unselected.focus.state-layer.color
  static const String unselectedFocusStateLayerColor = '0xFFCAC4D0';

  /// md.comp.filter-chip.unselected.hover.label-text.color
  static const String unselectedHoverLabelTextColor = '0xFFCAC4D0';

  /// md.comp.filter-chip.unselected.hover.state-layer.color
  static const String unselectedHoverStateLayerColor = '0xFFCAC4D0';
  ...
  static const String withLeadingIconDisabledLeadingIconColor = '0xFFE6E0E9';
  ...
  static const String withLeadingIconSelectedLeadingIconColor = '0xFFE8DEF8';
  ...
  static const String withLeadingIconUnselectedLeadingIconColor = '0xFFD0BCFF';
  ...
  static const String withTrailingIconDisabledTrailingIconColor = '0xFFE6E0E9';
  ...
  static const String withTrailingIconSelectedTrailingIconColor = '0xFFE8DEF8';

...
class TokenFullScreenDialogDarkHighContrast {
  ...
  static const String headerActionFocusLabelTextColor = '0xFFF6EDFF';

  /// md.comp.full-screen-dialog.header.action.focus.state-layer.color
  static const String headerActionFocusStateLayerColor = '0xFFF6EDFF';

  /// md.comp.full-screen-dialog.header.action.hover.label-text.color
  static const String headerActionHoverLabelTextColor = '0xFFF6EDFF';

  /// md.comp.full-screen-dialog.header.action.hover.state-layer.color
  static const String headerActionHoverStateLayerColor = '0xFFF6EDFF';

  /// md.comp.full-screen-dialog.header.action.label-text.color
  static const String headerActionLabelTextColor = '0xFFF6EDFF';

  /// md.comp.full-screen-dialog.header.action.pressed.label-text.color
  static const String headerActionPressedLabelTextColor = '0xFFF6EDFF';

  /// md.comp.full-screen-dialog.header.action.pressed.state-layer.color
  static const String headerActionPressedStateLayerColor = '0xFFF6EDFF';

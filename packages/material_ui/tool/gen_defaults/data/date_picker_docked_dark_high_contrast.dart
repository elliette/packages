...
class TokenDatePickerDockedDarkHighContrast {
  ...
  static const String dateSelectedContainerColor = '0xFFF6EDFF';

  /// md.comp.date-picker.docked.date.selected.focus.state-layer.color
  static const String dateSelectedFocusStateLayerColor = '0xFF000000';

  /// md.comp.date-picker.docked.date.selected.hover.state-layer.color
  static const String dateSelectedHoverStateLayerColor = '0xFF000000';

  /// md.comp.date-picker.docked.date.selected.label-text.color
  static const String dateSelectedLabelTextColor = '0xFF000000';

  /// md.comp.date-picker.docked.date.selected.pressed.state-layer.color
  static const String dateSelectedPressedStateLayerColor = '0xFF000000';

  /// md.comp.date-picker.docked.date.today.container.outline.color
  static const String dateTodayContainerOutlineColor = '0xFFF6EDFF';

  /// md.comp.date-picker.docked.date.today.focus.state-layer.color
  static const String dateTodayFocusStateLayerColor = '0xFFF6EDFF';

  /// md.comp.date-picker.docked.date.today.hover.state-layer.color
  static const String dateTodayHoverStateLayerColor = '0xFFF6EDFF';

  /// md.comp.date-picker.docked.date.today.label-text.color
  static const String dateTodayLabelTextColor = '0xFFF6EDFF';

  /// md.comp.date-picker.docked.date.today.pressed.state-layer.color
  static const String dateTodayPressedStateLayerColor = '0xFFF6EDFF';

  /// md.comp.date-picker.docked.date.unselected.focus.state-layer.color
  static const String dateUnselectedFocusStateLayerColor = '0xFFFFFFFF';

  /// md.comp.date-picker.docked.date.unselected.hover.state-layer.color
  static const String dateUnselectedHoverStateLayerColor = '0xFFFFFFFF';
  ...
  static const String dateUnselectedPressedStateLayerColor = '0xFFFFFFFF';
  ...
  static const String menuButtonFocusIconColor = '0xFFFFFFFF';

  /// md.comp.date-picker.docked.menu-button.focus.label-text.color
  static const String menuButtonFocusLabelTextColor = '0xFFFFFFFF';

  /// md.comp.date-picker.docked.menu-button.focus.state-layer.color
  static const String menuButtonFocusStateLayerColor = '0xFFFFFFFF';

  /// md.comp.date-picker.docked.menu-button.hover.icon.color
  static const String menuButtonHoverIconColor = '0xFFFFFFFF';

  /// md.comp.date-picker.docked.menu-button.hover.label-text.color
  static const String menuButtonHoverLabelTextColor = '0xFFFFFFFF';

  /// md.comp.date-picker.docked.menu-button.hover.state-layer.color
  static const String menuButtonHoverStateLayerColor = '0xFFFFFFFF';

  /// md.comp.date-picker.docked.menu-button.icon.color
  static const String menuButtonIconColor = '0xFFFFFFFF';

  /// md.comp.date-picker.docked.menu-button.label-text.color
  static const String menuButtonLabelTextColor = '0xFFFFFFFF';

  /// md.comp.date-picker.docked.menu-button.pressed.icon.color
  static const String menuButtonPressedIconColor = '0xFFFFFFFF';

  /// md.comp.date-picker.docked.menu-button.pressed.label-text.color
  static const String menuButtonPressedLabelTextColor = '0xFFFFFFFF';

  /// md.comp.date-picker.docked.menu-button.pressed.state-layer.color
  static const String menuButtonPressedStateLayerColor = '0xFFFFFFFF';
  ...
  static const String menuListItemSelectedFocusLeadingIconColor = '0xFFFFFFFF';

  /// md.comp.date-picker.docked.menu.list-item.selected.hover.leading-icon.color
  static const String menuListItemSelectedHoverLeadingIconColor = '0xFFFFFFFF';

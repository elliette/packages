...
class TokenButtonElevatedLightMediumContrast {
  ...
  static const String focusedIconColor = '0xFF4F378B';

  /// md.comp.button.elevated.focused.label-text.color
  static const String focusedLabelTextColor = '0xFF4F378B';

  /// md.comp.button.elevated.focused.state-layer.color
  static const String focusedStateLayerColor = '0xFF4F378B';

  /// md.comp.button.elevated.hovered.icon.color
  static const String hoveredIconColor = '0xFF4F378B';

  /// md.comp.button.elevated.hovered.label-text.color
  static const String hoveredLabelTextColor = '0xFF4F378B';

  /// md.comp.button.elevated.hovered.state-layer.color
  static const String hoveredStateLayerColor = '0xFF4F378B';

  /// md.comp.button.elevated.icon.color
  static const String iconColor = '0xFF4F378B';

  /// md.comp.button.elevated.label-text.color
  static const String labelTextColor = '0xFF4F378B';

  /// md.comp.button.elevated.pressed.icon.color
  static const String pressedIconColor = '0xFF4F378B';

  /// md.comp.button.elevated.pressed.label-text.color
  static const String pressedLabelTextColor = '0xFF4F378B';

  /// md.comp.button.elevated.pressed.state-layer.color
  static const String pressedStateLayerColor = '0xFF4F378B';
  ...
  static const String unselectedFocusedIconColor = '0xFF4F378B';

  /// md.comp.button.elevated.unselected.focused.label-text.color
  static const String unselectedFocusedLabelTextColor = '0xFF4F378B';

  /// md.comp.button.elevated.unselected.focused.state-layer.color
  static const String unselectedFocusedStateLayerColor = '0xFF4F378B';

  /// md.comp.button.elevated.unselected.hovered.icon.color
  static const String unselectedHoveredIconColor = '0xFF4F378B';

  /// md.comp.button.elevated.unselected.hovered.label-text.color
  static const String unselectedHoveredLabelTextColor = '0xFF4F378B';

  /// md.comp.button.elevated.unselected.hovered.state-layer.color
  static const String unselectedHoveredStateLayerColor = '0xFF4F378B';

  /// md.comp.button.elevated.unselected.icon.color
  static const String unselectedIconColor = '0xFF4F378B';

  /// md.comp.button.elevated.unselected.label-text.color
  static const String unselectedLabelTextColor = '0xFF4F378B';

  /// md.comp.button.elevated.unselected.pressed.icon.color
  static const String unselectedPressedIconColor = '0xFF4F378B';

  /// md.comp.button.elevated.unselected.pressed.label-text.color
  static const String unselectedPressedLabelTextColor = '0xFF4F378B';

...
class TokenDatePickerDockedLightMediumContrast {
  ...
  static const String dateSelectedContainerColor = '0xFF4F378B';
  ...
  static const String dateTodayContainerOutlineColor = '0xFF4F378B';

  /// md.comp.date-picker.docked.date.today.focus.state-layer.color
  static const String dateTodayFocusStateLayerColor = '0xFF4F378B';

  /// md.comp.date-picker.docked.date.today.hover.state-layer.color
  static const String dateTodayHoverStateLayerColor = '0xFF4F378B';

  /// md.comp.date-picker.docked.date.today.label-text.color
  static const String dateTodayLabelTextColor = '0xFF4F378B';

  /// md.comp.date-picker.docked.date.today.pressed.state-layer.color
  static const String dateTodayPressedStateLayerColor = '0xFF4F378B';

  /// md.comp.date-picker.docked.date.unselected.focus.state-layer.color
  static const String dateUnselectedFocusStateLayerColor = '0xFF322F37';

  /// md.comp.date-picker.docked.date.unselected.hover.state-layer.color
  static const String dateUnselectedHoverStateLayerColor = '0xFF322F37';
  ...
  static const String dateUnselectedPressedStateLayerColor = '0xFF322F37';
  ...
  static const String menuButtonFocusIconColor = '0xFF322F37';

  /// md.comp.date-picker.docked.menu-button.focus.label-text.color
  static const String menuButtonFocusLabelTextColor = '0xFF322F37';

  /// md.comp.date-picker.docked.menu-button.focus.state-layer.color
  static const String menuButtonFocusStateLayerColor = '0xFF322F37';

  /// md.comp.date-picker.docked.menu-button.hover.icon.color
  static const String menuButtonHoverIconColor = '0xFF322F37';

  /// md.comp.date-picker.docked.menu-button.hover.label-text.color
  static const String menuButtonHoverLabelTextColor = '0xFF322F37';

  /// md.comp.date-picker.docked.menu-button.hover.state-layer.color
  static const String menuButtonHoverStateLayerColor = '0xFF322F37';

  /// md.comp.date-picker.docked.menu-button.icon.color
  static const String menuButtonIconColor = '0xFF322F37';

  /// md.comp.date-picker.docked.menu-button.label-text.color
  static const String menuButtonLabelTextColor = '0xFF322F37';

  /// md.comp.date-picker.docked.menu-button.pressed.icon.color
  static const String menuButtonPressedIconColor = '0xFF322F37';

  /// md.comp.date-picker.docked.menu-button.pressed.label-text.color
  static const String menuButtonPressedLabelTextColor = '0xFF322F37';

  /// md.comp.date-picker.docked.menu-button.pressed.state-layer.color
  static const String menuButtonPressedStateLayerColor = '0xFF322F37';
  ...
  static const String menuListItemSelectedFocusLeadingIconColor = '0xFF322F37';

  /// md.comp.date-picker.docked.menu.list-item.selected.hover.leading-icon.color
  static const String menuListItemSelectedHoverLeadingIconColor = '0xFF322F37';

...
class TokenListRevealDarkDefault {
  ...
  static const String listItemActionIconButtonContainerColor = '0xFFD0BCFF';
  ...
  static const String listItemActionIconButtonIconColor = '0xFF381E72';
  ...
  static const String listItemIconButtonFocusedStateLayerColor = '0xFFE8DEF8';

  /// md.comp.list.reveal.list-item.icon-button.hovered.state-layer.color
  static const String listItemIconButtonHoveredStateLayerColor = '0xFFE8DEF8';

  /// md.comp.list.reveal.list-item.icon-button.icon.color
  static const String listItemIconButtonIconColor = '0xFFE8DEF8';

  /// md.comp.list.reveal.list-item.icon-button.pressed.state-layer.color
  static const String listItemIconButtonPressedStateLayerColor = '0xFFE8DEF8';
}

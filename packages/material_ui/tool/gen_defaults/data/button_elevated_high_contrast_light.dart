...
class TokenButtonElevatedHighContrast_light {
  ...
  static const String unselectedFocusedIconColor = '0xFF381E72';

  /// md.comp.button.elevated.unselected.focused.label-text.color
  static const String unselectedFocusedLabelTextColor = '0xFF381E72';

  /// md.comp.button.elevated.unselected.focused.state-layer.color
  static const String unselectedFocusedStateLayerColor = '0xFF381E72';

  /// md.comp.button.elevated.unselected.hovered.icon.color
  static const String unselectedHoveredIconColor = '0xFF381E72';

  /// md.comp.button.elevated.unselected.hovered.label-text.color
  static const String unselectedHoveredLabelTextColor = '0xFF381E72';

  /// md.comp.button.elevated.unselected.hovered.state-layer.color
  static const String unselectedHoveredStateLayerColor = '0xFF381E72';

  /// md.comp.button.elevated.unselected.icon.color
  static const String unselectedIconColor = '0xFF381E72';

  /// md.comp.button.elevated.unselected.label-text.color
  static const String unselectedLabelTextColor = '0xFF381E72';

  /// md.comp.button.elevated.unselected.pressed.icon.color
  static const String unselectedPressedIconColor = '0xFF381E72';

  /// md.comp.button.elevated.unselected.pressed.label-text.color
  static const String unselectedPressedLabelTextColor = '0xFF381E72';

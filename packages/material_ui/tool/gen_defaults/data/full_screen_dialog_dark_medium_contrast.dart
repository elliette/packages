...
class TokenFullScreenDialogDarkMediumContrast {
  ...
  static const String headerActionFocusLabelTextColor = '0xFFEADDFF';

  /// md.comp.full-screen-dialog.header.action.focus.state-layer.color
  static const String headerActionFocusStateLayerColor = '0xFFEADDFF';

  /// md.comp.full-screen-dialog.header.action.hover.label-text.color
  static const String headerActionHoverLabelTextColor = '0xFFEADDFF';

  /// md.comp.full-screen-dialog.header.action.hover.state-layer.color
  static const String headerActionHoverStateLayerColor = '0xFFEADDFF';

  /// md.comp.full-screen-dialog.header.action.label-text.color
  static const String headerActionLabelTextColor = '0xFFEADDFF';

  /// md.comp.full-screen-dialog.header.action.pressed.label-text.color
  static const String headerActionPressedLabelTextColor = '0xFFEADDFF';

  /// md.comp.full-screen-dialog.header.action.pressed.state-layer.color
  static const String headerActionPressedStateLayerColor = '0xFFEADDFF';
  ...
  static const String headerIconColor = '0xFFFFFFFF';

  /// md.comp.full-screen-dialog.header.on-scroll.container.color
  static const String headerOnScrollContainerColor = '0xFF211F26';
}

...
class TokenCheckboxDarkMediumContrast {
  ...
  static const String errorFocusStateLayerColor = '0xFFF9DEDC';

  /// md.comp.checkbox.error.hover.state-layer.color
  static const String errorHoverStateLayerColor = '0xFFF9DEDC';

  /// md.comp.checkbox.error.pressed.state-layer.color
  static const String errorPressedStateLayerColor = '0xFFF9DEDC';
  ...
  static const String selectedErrorContainerColor = '0xFFF9DEDC';

  /// md.comp.checkbox.selected.error.focus.container.color
  static const String selectedErrorFocusContainerColor = '0xFFF9DEDC';

  /// md.comp.checkbox.selected.error.focus.icon.color
  static const String selectedErrorFocusIconColor = '0xFF410E0B';

  /// md.comp.checkbox.selected.error.hover.container.color
  static const String selectedErrorHoverContainerColor = '0xFFF9DEDC';

  /// md.comp.checkbox.selected.error.hover.icon.color
  static const String selectedErrorHoverIconColor = '0xFF410E0B';

  /// md.comp.checkbox.selected.error.icon.color
  static const String selectedErrorIconColor = '0xFF410E0B';

  /// md.comp.checkbox.selected.error.pressed.container.color
  static const String selectedErrorPressedContainerColor = '0xFFF9DEDC';

  /// md.comp.checkbox.selected.error.pressed.icon.color
  static const String selectedErrorPressedIconColor = '0xFF410E0B';

  /// md.comp.checkbox.selected.focus.container.color
  static const String selectedFocusContainerColor = '0xFFEADDFF';

  /// md.comp.checkbox.selected.focus.icon.color
  static const String selectedFocusIconColor = '0xFF21005D';
  ...
  static const String selectedHoverContainerColor = '0xFFEADDFF';

  /// md.comp.checkbox.selected.hover.icon.color
  static const String selectedHoverIconColor = '0xFF21005D';
  ...
  static const String selectedPressedContainerColor = '0xFFEADDFF';
  ...
  static const String unselectedErrorFocusOutlineColor = '0xFFF9DEDC';

  /// md.comp.checkbox.unselected.error.hover.outline.color
  static const String unselectedErrorHoverOutlineColor = '0xFFF9DEDC';

  /// md.comp.checkbox.unselected.error.outline.color
  static const String unselectedErrorOutlineColor = '0xFFF9DEDC';

  /// md.comp.checkbox.unselected.error.pressed.outline.color
  static const String unselectedErrorPressedOutlineColor = '0xFFF9DEDC';
  ...
  static const String unselectedOutlineColor = '0xFFE7E0EC';
  ...
  static const String unselectedPressedStateLayerColor = '0xFFEADDFF';
}

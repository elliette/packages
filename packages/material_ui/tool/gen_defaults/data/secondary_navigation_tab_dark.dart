...
class TokenSecondaryNavigationTabDark {
  ...
  static const String withIconActiveIconColor = '0xFFE6E0E9';

  /// md.comp.secondary-navigation-tab.with-icon.focus.icon.color
  static const String withIconFocusIconColor = '0xFFE6E0E9';

  /// md.comp.secondary-navigation-tab.with-icon.hover.icon.color
  static const String withIconHoverIconColor = '0xFFE6E0E9';
  ...
  static const String withIconPressedIconColor = '0xFFE6E0E9';
}
